...
export class NavMenu extends Component {
  ...
  render() {
    return (
      <header>
        <Navbar className="navbar-expand-sm navbar-toggleable-sm ng-white border-bottom box-shadow mb-3" container color="fff">
          <NavbarBrand tag={Link} className="text-light" to="/">Tasky</NavbarBrand>
