...
namespace Tasky.Data.Migrations
{
    ...
    [Migration("20230505200153_initalize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tasky.Models.Task", b =>
                {
                    ...
                    b.Property<int>("CreatorApplicationUserID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tasky.Models.TaskListMeta", b =>
                {
                    b.Property<int>("TaskListID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tasky.Models.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tasky.Models.Task", b =>
                {
                    b.HasOne("Tasky.Models.UserAccount", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tasky.Models.TaskList", null)
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("Tasky.Models.TaskListMeta", b =>
                {
                    ...
                    b.HasOne("Tasky.Models.UserAccount", "UserAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Tasky.Models.UserAccount", b =>
                {
                    b.HasOne("Tasky.Models.ApplicationUser", "User")
                        .WithOne("Account")
                        .HasForeignKey("Tasky.Models.UserAccount", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
